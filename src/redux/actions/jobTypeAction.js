...
export const jobTypeLoadAction = () => async (dispatch) => {
    ...
    try {
        const { data } = await axios.get('https://jobportalbackend-wzzz.onrender.com/api/type/jobs');
        dispatch({
...
export const createJobTypeAction = (jobtype) => async (dispatch) => {
    ...
    try {
        const { data } = await axios.post("https://jobportalbackend-wzzz.onrender.com/api/type/create", jobtype)
        dispatch({
